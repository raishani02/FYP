...
const state = {
 ...
 function ProjectDeliverableChart () {
    ...
    return (
      ...
      <Modal show={isProjectDeliverableModalOpen} onHide={closeProjectDeliverableModal}  style={{marginTop: "25px"}}>
        <Modal.Header closeButton style={{ fontSize: "20px" }}>
          <strong>Project Deliverables Progress of {courseValue} for Section {sectionValue} is: </strong>
        </Modal.Header>
        <Modal.Body>
        <div>
        <Doughnut
...
export default ProjectDeliverableChart;